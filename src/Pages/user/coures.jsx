            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {courseData.map((course, index) => (
                    <div key={index} className="flex items-center justify-center px-5">
                        <a href="#" className="group flex flex-col items-center overflow-hidden rounded-lg border border-gray-200 bg-white shadow hover:bg-blue-50 md:max-w-xl md:flex-row">
