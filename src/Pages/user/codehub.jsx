  ...
  return (
    <div className="pt-[87px]">
      <div className="justify-center  flex flex-no-wrap text-center bg-white-500 border-b-[3px] ">
        <div
          className=" cursor-pointer w-[15%] m-2 p-2 text-center bg-gray-200 rounded-2xl text-2xl  flex flex-row justify-around items-center"
          onClick={() => {
            setdsa(true);
            setfront(false);
            setbackend(false);
        ...
        >
          DSA Sheet
          {dsa ? (
            <IoIosArrowDropdownCircle className="text-center m-1" />
          ) : (
            <IoIosArrowDropdown className="text-center m-1" />
          )}
        </div>
        <div
          className=" cursor-pointer w-[15%] m-2 p-2 text-center bg-gray-200 rounded-2xl text-2xl  flex flex-row justify-around items-center"
          ...
          <>
            ...
            <div>
              <div className="bg-white m-5 mt-10 mr-0 grid gap-4 ">
                <div
                  className="bg-blue-200 rounded-2xl p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                  onClick={() => setstatus1(!status1)}
                >
                  <h1>
                    <b>STEP 1</b> : LEARN THE BASIC
                  </h1>
                </div>
                <div>
                  {status1 ? (
                    <>
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus1_1(!status1_1)}
                      >
                        <h1>
                          <b>STEP 1.1</b> : Things to Know in C++/Java/Python or
                          any language
                        </h1>
                      </div>
                      <div>
                        {status1_1 ? (
                          <>
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              ...
                              <a href="https://www.codingninjas.com/studio/problems/find-character-case_58513">
                                <div className=" flex-shrink-0 w-[50px] h-[30px] flex items-center justify-center  border border-black">
                                  <CiLink />
                                </div>
                              </a>
                            </div>
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              ...
                              <a href="https://www.codingninjas.com/studio/problems/data-type_8357232">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                                  <CiLink />
                                </div>
                              </a>
                            </div>
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              ...
                              <a href="https://www.codingninjas.com/studio/problems/if-else-decision-making_8357235">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                                  <CiLink />
                                </div>
                              </a>
                            ...
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              ...
                              <a href="https://www.codingninjas.com/studio/problems/switch-case-statement_8357244">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                                  <CiLink />
                                </div>
                              </a>
                            ...
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              ...
                              <a href="https://www.codingninjas.com/studio/problems/nth-fibonacci-number_74156">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                                  <CiLink />
                                </div>
                              </a>
                            ...
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              ...
                              <a href="https://www.codingninjas.com/studio/problems/sum-of-even-odd_624650">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                                  <CiLink />
                                </div>
                              </a>
                            ...
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              ...
                              <a href="https://www.codingninjas.com/studio/problems/fa-1-ece_4606261">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                                  <CiLink />
                                </div>
                              </a>
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus1_2(!status1_2)}
                      >
                        <h1>
                          <b>STEP 1.2</b> : Build-up Logical Thinking
                        </h1>
                      </div>
                      <div>
                        {status1_2 ? (
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus1_3(!status1_3)}
                      >
                        <h1>
                          <b>STEP 1.3</b> : Learn STL/Java-Collections or
                          similar thing in your language
                        </h1>
                      </div>
                      <div>
                        {status1_3 ? (
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus1_4(!status1_4)}
                      >
                        <h1>
                          <b>STEP 1.4</b> : Know Basic Maths
                        </h1>
                      </div>
                      <div>
                        {status1_4 ? (
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus1_5(!status1_5)}
                      >
                        <h1>
                          <b>STEP 1.5</b> : Learn Basic Recursion
                        </h1>
                      </div>
                      <div>
                        {status1_5 ? (
                          <>
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              <div className="flex-shrink-0">
                                Understand Recursion by printing something N
                                times
                              </div>
                              <a href="">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus1_6(!status1_6)}
                      >
                        <h1>
                          <b>STEP 1.6</b> : Learn Basic Hashing
                        </h1>
                      </div>
                      <div>
                        {status1_6 ? (
                ...
                >
                  <h1>
                    <b>STEP 2</b> : Learn Important Sorting Techniques
                  </h1>
                </div>
                <div>
                  {status2 ? (
                    <>
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus2_1(!status2_1)}
                      >
                        <h1>
                          <b>STEP 2.1</b> : Sorting-I
                        </h1>
                      </div>
                      <div>
                        {status2_1 ? (
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus2_2(!status2_2)}
                      >
                        <h1>
                          <b>STEP 2.2</b> : Sorting-II
                        </h1>
                      </div>
                      <div>
                        {status2_2 ? (
                ...
                >
                  <h1>
                    <b>STEP 3 </b> : Solve Problems on Arrays [Easy -{">"}{" "}
                    Medium -{">"} Hard]
                  </h1>
                </div>
                <div>
                  {status3 ? (
                    <>
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus3_1(!status3_1)}
                      >
                        <h1>
                          <b>STEP 3.1</b> : Easy
                        </h1>
                      ...
                      <div>
                        {status3_1 ? (
                          <>
                            ...
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              <div className="flex-shrink-0">
                                Find the number that appears once, and the other
                                numbers twice
                              </div>
                              <a href="">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                            ...
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              <div className="flex-shrink-0">
                                Longest Subarray with sum K | [Postives and
                                Negatives]
                              </div>
                              <a href="">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus3_2(!status3_2)}
                      >
                        <h1>
                          <b>STEP 3.2</b> : Medium
                        </h1>
                      ...
                      <div>
                        {status3_2 ? (
                          <>
                            ...
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              <div className="flex-shrink-0">
                                Kadane’s Algorithm : Maximum Subarray Sum in an
                                Array
                              </div>
                              <a href="">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                            ...
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              <div className="flex-shrink-0">
                                KaPrint subarray with maximum subarray Sum in an
                                Array
                              </div>
                              <a href="">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus3_3(!status3_3)}
                      >
                        <h1>
                          <b>STEP 3.3</b> : Hard
                        </h1>
                ...
                >
                  <h1>
                    <b>STEP 4</b> : Binary Search [1D, 2D Arrays, Search Space]
                  </h1>
                </div>
                <div>
                  {status4 ? (
                    <>
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus4_1(!status4_1)}
                      >
                        <h1>
                          <b>STEP 4.1</b> : BS on 1D Arrays
                        </h1>
                      </div>
                      <div>
                        {status4_1 ? (
                          <>
                            ...
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              <div className="flex-shrink-0">
                                Find out how many times the array has been
                                rotated
                              </div>
                              <a href="">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus4_2(!status4_2)}
                      >
                        <h1>
                          <b>STEP 4.2</b> : BS on Answers
                        </h1>
                      </div>
                      <div>
                        {status4_2 ? (
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus4_3(!status4_3)}
                      >
                        <h1>
                          <b>STEP 4.3</b> : BS on 2D Arrays
                        </h1>
                      </div>
                      <div>
                        {status4_3 ? (
                ...
                >
                  <h1>
                    <b>STEP 5</b> : Strings [Basic and Medium]
                  </h1>
                </div>
                <div>
                  {status5 ? (
                    <>
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus5_1(!status5_1)}
                      >
                        <h1>
                          <b>STEP 5.1</b> : Basic and Easy String Problems
                        </h1>
                      </div>
                      <div>
                        {status5_1 ? (
                          <>
                            ...
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              <div className="flex-shrink-0">
                                check whether one string is a rotat…
                              </div>
                              <a href="">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                                  <CiLink />
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus5_2(!status5_2)}
                      >
                        <h1>
                          <b>STEP 5.2</b> : Medium String Problems
                        </h1>
                      </div>
                      <div>
                        {status5_2 ? (
                          <>
                            ...
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              <div className="flex-shrink-0">
                                Roman Number to Integer and vice ve...
                              </div>
                              <a href="">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                                  <CiLink />
                            ...
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              <div className="flex-shrink-0">
                                Longest Palindromic Substring Do it…
                              </div>
                              <a href="">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                                  <CiLink />
                ...
                <div
                  className="bg-blue-200 rounded-2xl p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black "
                  onClick={() => setstatus6(!status6)}
                >
                  <h1>
                    <b>STEP 6</b> : Learn LinkedList [Single LL, Double LL,
                ...
                <div>
                  {status6 ? (
                    <>
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus6_1(!status6_1)}
                      >
                        <h1>
                          <b>STEP 6.1</b> : Learn 1D LinkedList
                        </h1>
                      </div>
                      <div>
                        {status6_1 ? (
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus6_2(!status6_2)}
                      >
                        <h1>
                          <b>STEP 6.2</b> : Learn Doubly LinkedList
                        </h1>
                      </div>
                      <div>
                        {status6_2 ? (
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus6_3(!status6_3)}
                      >
                        <h1>
                          <b>STEP 6.3</b> : Medium Problems of LL
                        </h1>
                      </div>
                      <div>
                        {status6_3 ? (
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus6_4(!status6_4)}
                      >
                        <h1>
                          <b>STEP 6.4</b> : Medium Problems of DLL
                        </h1>
                      </div>
                      <div>
                        {status6_4 ? (
                          <>
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              <div className="flex-shrink-0">
                                Delete all occurrences of a key in...
                              </div>
                              <a href="">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                                  <CiLink />
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus6_5(!status6_5)}
                      >
                        <h1>
                          <b>STEP 6.5</b> : Hard Problems of LL
                        </h1>
                      </div>
                      <div>
                        {status6_5 ? (
                ...
                <div
                  className="bg-blue-200 rounded-2xl p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black "
                  onClick={() => setstatus7(!status7)}
                >
                  <h1>
                    <b>STEP 7</b> : Recursion [PatternWise]
                  </h1>
                </div>
                <div>
                  {status7 ? (
                    <>
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus7_1(!status7_1)}
                      >
                        <h1>
                          <b>STEP 7.1</b> : Get a Strong Hold
                        </h1>
                      </div>
                      <div>
                        {status7_1 ? (
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus7_2(!status7_2)}
                      >
                        <h1>
                          <b>STEP 7.2</b> : Subsequences Pattern
                        </h1>
                      </div>
                      <div>
                        {status7_2 ? (
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus7_3(!status7_3)}
                      >
                        <h1>
                          <b>STEP 7.3</b> : Trying out all Combos / Hard
                        </h1>
                      </div>
                      <div>
                        {status7_3 ? (
                ...
                <div
                  className="bg-blue-200 rounded-2xl p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black "
                  onClick={() => setstatus8(!status8)}
                >
                  <h1>
                    <b>STEP 8</b> : Bit Manipulation [Concepts & Problems]
                  </h1>
                </div>
                <div>
                  {status8 ? (
                    <>
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus8_1(!status8_1)}
                      >
                        <h1>
                          <b>STEP 8.1</b> : Learn Bit Manipulation
                        </h1>
                      </div>
                      <div>
                        {status8_1 ? (
                          <>
                            ...
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              <div className="flex-shrink-0">
                                {" "}
                                Divide two integers without using m…
                              </div>
                              <a href="">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                                  <CiLink />
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus8_2(!status8_2)}
                      >
                        <h1>
                          <b>STEP 8.2</b> : Interview Problems
                        </h1>
                      </div>
                      <div>
                        {status8_2 ? (
                          <>
                            ...
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              <div className="flex-shrink-0">
                                {" "}
                                Find the number that appears odd nu…
                              </div>
                              <a href="">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                                  <CiLink />
                            ...
                            <div className="flex justify-between items-center bg-blue-200 rounded-2xl mb-5 ml-10 mr-10 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black">
                              <div className="flex-shrink-0">
                                Find the two numbers appearing odd …
                              </div>
                              <a href="">
                                <div className="flex-shrink-0 w-[50px] flex items-center justify-center border border-black  h-[30px]">
                                  <CiLink />
                      ...
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                        onClick={() => setstatus8_3(!status8_3)}
                      >
                        <h1>
                          <b>STEP 8.3</b> : Advanced Maths
                        </h1>
                      </div>
                      <div>
                        {status8_3 ? (
                ...
                <div
                  className="bg-blue-200 rounded-2xl p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black "
                  onClick={() => setstatus9(!status9)}
                >
                  <h1>
                    <b>STEP 9</b> : Stack and Queues [Learning, Pre-In-Post-fix,
                ...
                <div>
                  {status9 ? (
                    <>
                      ...
                      >
                        <h1>
                          <b>STEP 9.2</b> : Prefix, Infix, PostFix Conversion
                          Problems
                        </h1>
                      </div>
                      <div
                      ...
                      >
                        <h1>
                          <b>STEP 9.3</b> : Monotonic Stack/Queue Problems [VVV.
                          Imp]
                        </h1>
                      </div>
                      <div
                      ...
                      >
                        <h1>
                          <b>STEP 9.4</b> : Implementation Problems
                        </h1>
                      </div>
                    </>
                  ) : null}
                ...
                <div
                  className="bg-blue-200 rounded-2xl p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black "
                  onClick={() => setstatus10(!status10)}
                >
                  <h1>
                    <b>STEP 10</b> : Sliding Window & Two Pointer Combined
                    Problems
                  </h1>
                </div>
                <div>
                ...
                <div
                  className="bg-blue-200 rounded-2xl p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black "
                  onClick={() => setstatus11(!status11)}
                >
                  <h1>
                    <b>STEP 11</b> : Heaps [Learning, Medium, Hard Problems]
                  </h1>
                </div>
                <div>
                  {status11 ? (
                ...
                <div
                  className="bg-blue-200 rounded-2xl p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black "
                  onClick={() => setstatus12(!status12)}
                >
                  <h1>
                    <b>STEP 12</b> : Greedy Algorithms [Easy, Medium/Hard]
                  </h1>
                </div>
                <div>
                  {status12 ? (
                ...
                <div
                  className="bg-blue-200 rounded-2xl p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black "
                  onClick={() => setstatus13(!status13)}
                >
                  <h1>
                    <b>STEP 13</b> : Binary Trees [Traversals, Medium and Hard
                    Problems]
                  </h1>
                </div>
                <div>
                ...
                <div
                  className="bg-blue-200 rounded-2xl p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black "
                  onClick={() => setstatus14(!status14)}
                >
                  <h1>
                    <b>STEP 14</b> : Binary Search Trees [Concept and Problems]
                  </h1>
                </div>
                <div>
                  {status14 ? (
                    <>
                      ...
                      >
                        <h1>
                          <b>STEP 14.2</b> : Practice Problems
                        </h1>
                      </div>
                    </>
                  ) : null}
                ...
                <div
                  className="bg-blue-200 rounded-2xl p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black "
                  onClick={() => setstatus15(!status15)}
                >
                  <h1>
                    <b>STEP 15</b> : Graphs [Concepts & Problems]
                  </h1>
                </div>
                <div>
                  {status15 ? (
                    <>
                      ...
                      >
                        <h1>
                          <b>STEP 15.2</b> : Problems on BFS/DFS
                        </h1>
                      </div>
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                      ...
                      >
                        <h1>
                          <b>STEP 15.3</b> : Topo Sort and Problems
                        </h1>
                      </div>
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                      ...
                      >
                        <h1>
                          <b>STEP 15.4</b> : Shortest Path Algorithms and
                          Problems
                        </h1>
                      </div>
                      <div
                      ...
                      >
                        <h1>
                          <b>STEP 15.5</b> : MinimumSpanningTree/Disjoint Set
                          and Problems
                        </h1>
                      </div>
                      <div
                      ...
                      >
                        <h1>
                          <b>STEP 15.6</b> : Other Algorithms
                        </h1>
                      </div>
                    </>
                  ) : null}
                ...
                <div
                  className="bg-blue-200 rounded-2xl p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black "
                  onClick={() => setstatus16(!status16)}
                >
                  <h1>
                    <b>STEP 16</b> : Dynamic Programming [Patterns and Problems]
                  </h1>
                </div>
                <div>
                  {status16 ? (
                    <>
                      ...
                      >
                        <h1>
                          <b>STEP 16.1</b> : Introduction to DP
                        </h1>
                      </div>
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                      ...
                      >
                        <h1>
                          <b>STEP 16.3</b> : 2D/3D DP and DP on Grids
                        </h1>
                      </div>
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                      ...
                      >
                        <h1>
                          <b>STEP 16.4</b> : DP on Subsequences
                        </h1>
                      </div>
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
                      ...
                      >
                        <h1>
                          <b>STEP 16.8</b> : MCM DP | Partition DP
                        </h1>
                      </div>
                      <div
                        className="bg-blue-200 rounded-2xl m-5 p-3 uppercase hover:bg-blue-300 hover:border-2 border-dotted border-black"
