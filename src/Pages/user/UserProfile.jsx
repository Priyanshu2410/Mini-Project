                ...
                <>
                  ...
                  <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-30rem">
                    <div className="bg-white rounded-lg p-5">
                      <div className=" text-black pb-5 flex flex-row justify-between">
                      ...
                      <form onSubmit={handleSubmit}>
                        ...
                        <select
                          name="gender"
                          required
                          className="text-sm w-full px-4 py-2 border border-solid invalid:text-gray-500 border-gray-300 rounded mt-4"
                        ...
                        <select
                          name="dept"
                          required
                          className="text-sm w-full px-4 py-2 border border-solid border-gray-300 invalid:text-gray-500 rounded mt-4"
