    ...
    <footer
      ...
      <div
        ...
        <div className="mr-12 hidden lg:block">
          <span>Get connected with us on social dvdvnetworks:</span>
        </div>
        {/* <!-- Social network icons container --> */}
        <div className="flex justify-center">
          <a href='link-to-react' className="mr-6 text-neutral-600 dark:text-neutral-200">
            <svg
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            <h6
              className="mb-4 text-[#2596be] flex items-center justify-center font-semibold uppercase md:justify-start">
          ...
          <div className="">
            ...
            <p className="mb-4">
              <a href="link-to-react"className="text-neutral-600 dark:text-neutral-200"
              >ReactJS</a>
            </p>
            <p className="mb-4">
              <a href="link-to-react" className="text-neutral-600 dark:text-neutral-200"
              >Intoduction to IOT</a>
            </p>
            <p className="mb-4">
              <a href="link-to-react" className="text-neutral-600 dark:text-neutral-200"
              >Intoduction to AI</a>
